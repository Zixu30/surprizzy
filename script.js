...
function renderProducts(){
  ...
  const wishlist=JSON.parse(localStorage.getItem("surprizzyWishlist")||"[]");
  ...
  document.getElementById("productsGrid").innerHTML=list.length
    ...
    : `<div class="empty">No gifts found. Try another search ✨</div>`;
}
...
function toggleWish(id, button){
  let wishlist=JSON.parse(localStorage.getItem("surprizzyWishlist")||"[]");
